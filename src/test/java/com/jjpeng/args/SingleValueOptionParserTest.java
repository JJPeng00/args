...
public class SingleValueOptionParserTest {
    ...
    public void should_not_accept_extra_argument_for_single_value_option() {
        TooManyArgumentException e = Assertions.assertThrows(TooManyArgumentException.class, () -> {
            OptionParsers.unary(Integer::parseInt, (Integer) 0).parse(List.of("-p", "8080", "8081"), BooleanOptionParserTest.option("p"));
        });
    ...
    public void should_not_accept_insufficient_argument_for_single_value_option() {
        InsufficientArgumentException e = Assertions.assertThrows(InsufficientArgumentException.class, () -> {
            OptionParsers.unary(Integer::parseInt, (Integer) 0).parse(List.of("-p"), BooleanOptionParserTest.option("p"));
        });
    ...
    public void should_not_accept_insufficient_argument_with_other_argument_for_single_value_option() {
        InsufficientArgumentException e = Assertions.assertThrows(InsufficientArgumentException.class, () -> {
            OptionParsers.unary(Integer::parseInt, (Integer) 0).parse(List.of("-p", "-l"), BooleanOptionParserTest.option("p"));
        });
    ...
    public void should_set_default_value_to_0_for_int_option() {
        Assertions.assertEquals(0, OptionParsers.unary(Integer::parseInt, (Integer) 0).parse(List.of(), BooleanOptionParserTest.option("p")));
    }

    //happy path
    @Test
    public void should_parse_value_if_flag_present() {
        Assertions.assertEquals(8080, OptionParsers.unary(Integer::parseInt, (Integer) 0).parse(List.of("-p", "8080"), BooleanOptionParserTest.option("p")));
    }
